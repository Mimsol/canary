...
GameStore.Categories = {
		...
		offers = {
			{
				...
				name = "A few tibia coins",
				price = 10,
				itemtype = 22118,
				count = 10,
				description = "<i>Use it to add tibia coins to your store balance!</i>\n\nYou can use this item to safely trade tibia coins with other players.",
	...
	--  Online Points
	{
		...
		name = "Online Points",
		rookgaard = true,
		subclasses = { "Basic Exercise Weapons" },
	},
}
...
function generateExerciseOffers()
	...
	local tiers = {
		{ name = "Basic", offers = { { price = 45, charges = 1800 }, { price = 165, charges = 7200 }, { price = 625, charges = 1800, coinType = GameStore.CoinType.Coin} } },
