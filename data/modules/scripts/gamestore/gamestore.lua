...
GameStore.Categories = {
		...
		offers = {
			{
				...
				name = "A few elysiera coins",
				price = 10,
				itemtype = 22118,
				count = 10,
				description = "<i>Use it to add elysiera coins to your store balance!</i>\n\nYou can use this item to safely trade elysiera coins with other players.",
	...
	},
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 37536,
				count = 1,
				description = "<i>a container with 200 slots</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true,
			},
			{
				name = "Galthen's satchel",
				price = 20,
				itemtype = 36813,
				count = 1,
				description = "<i>a container with 32 slots</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true,
			},
			{
	...
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Concoctions", "Potions", "Runes", "Exercise Swords", "Exercise Axes", "Exercise Clubs", "Exercise Bows", "Exercise Rods", "Exercise Wands" },
	},
		-- Consumables ~ Concoctions
	{
		...
		state = GameStore.States.STATE_NONE,
		offers = {
				{ name = "Stamina Extension", price = 50, itemtype = Concoction.Ids.StaminaExtension, count = 1,nhancementription = "<i>Gives you + one hour of stamina upon usage.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Kooldown Aid", price = 50, itemtype = Concoction.Ids.KooldownAid, count = 1,nhancementription = "<i>Clears all of your spell cooldowns.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Strike Enhancement", price = 50, itemtype = Concoction.Ids.StrikeEnhancement, count = 1, description = "<i>Gives you one hour of +5% critical hit chance.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				-- { name = "Charm Upgrade", price = 50, itemtype = Concoction.Ids.CharmUpgrade, count = 1, description = "<i>Gives you one hour of +5% charm activation chance.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Wealth Duplex", price = 75, itemtype = Concoction.Ids.WealthDuplex, count = 1, description = "<i>Gives you one hour of double loot.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Bestiary Betterment", price = 75, itemtype = Concoction.Ids.BestiaryBetterment, count = 1, description = "<i>Gives you one hour of double bestiary kills.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Fire Resilience", price = 50, itemtype = Concoction.Ids.FireResilience, count = 1, description = "<i>Gives you one hour of +8% fire resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Ice Resilience", price = 50, itemtype = Concoction.Ids.IceResilience, count = 1, description = "<i>Gives you one hour of +8% ice resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Earth Resilience", price = 50, itemtype = Concoction.Ids.EarthResilience, count = 1, description = "<i>Gives you one hour of +8% earth resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Energy Resilience", price = 50, itemtype = Concoction.Ids.EnergyResilience, count = 1, description = "<i>Gives you one hour of +8% energy resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Holy Resilience", price = 50, itemtype = Concoction.Ids.HolyResilience, count = 1, description = "<i>Gives you one hour of +8% holy resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Death Resilience", price = 50, itemtype = Concoction.Ids.DeathResilience, count = 1, description = "<i>Gives you one hour of +8% death resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Physical Resilience", price = 50, itemtype = Concoction.Ids.PhysicalResilience, count = 1, description = "<i>Gives you one hour of +8% physical resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Fire Amplification", price = 50, itemtype = Concoction.Ids.FireAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on fire damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Ice Amplification", price = 50, itemtype = Concoction.Ids.IceAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on ice damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Earth Amplification", price = 50, itemtype = Concoction.Ids.EarthAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on earth damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Energy Amplification", price = 50, itemtype = Concoction.Ids.EnergyAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on energy damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Holy Amplification", price = 50, itemtype = Concoction.Ids.HolyAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on holy damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Death Amplification", price = 50, itemtype = Concoction.Ids.DeathAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on death damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
				{ name = "Physical Amplification", price = 50, itemtype = Concoction.Ids.PhysicalAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on physical damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
		}
	},
		-- Consumables ~ Potions
	{
	...
	--  Online Points
	{
		...
		name = "Online Points",
		rookgaard = true,
		subclasses = { "Basic Exercise Weapons", "Tools ", "Boosts & Others", "Concoctions " },
	},
	{
		icons = { "Category_Boosts.png" },
		name = "Boosts & Others",
	...
	},
	{
		...
		state = GameStore.States.STATE_NONE,
		offers = {
				{ name = "Stamina Extension", price = 500, itemtype = Concoction.Ids.StaminaExtension, count = 1,nhancementription = "<i>Gives you + one hour of stamina upon usage.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Kooldown Aid", price = 500, itemtype = Concoction.Ids.KooldownAid, count = 1,nhancementription = "<i>Clears all of your spell cooldowns.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Strike Enhancement", price = 500, itemtype = Concoction.Ids.StrikeEnhancement, count = 1, description = "<i>Gives you one hour of +5% critical hit chance.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				-- { name = "Charm Upgrade", price = 500, itemtype = Concoction.Ids.CharmUpgrade, count = 1, description = "<i>Gives you one hour of +5% charm activation chance.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Wealth Duplex", price = 750, itemtype = Concoction.Ids.WealthDuplex, count = 1, description = "<i>Gives you one hour of double loot.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Bestiary Betterment", price = 750, itemtype = Concoction.Ids.BestiaryBetterment, count = 1, description = "<i>Gives you one hour of double bestiary kills.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Fire Resilience", price = 500, itemtype = Concoction.Ids.FireResilience, count = 1, description = "<i>Gives you one hour of +8% fire resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Ice Resilience", price = 500, itemtype = Concoction.Ids.IceResilience, count = 1, description = "<i>Gives you one hour of +8% ice resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Earth Resilience", price = 500, itemtype = Concoction.Ids.EarthResilience, count = 1, description = "<i>Gives you one hour of +8% earth resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Energy Resilience", price = 500, itemtype = Concoction.Ids.EnergyResilience, count = 1, description = "<i>Gives you one hour of +8% energy resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Holy Resilience", price = 500, itemtype = Concoction.Ids.HolyResilience, count = 1, description = "<i>Gives you one hour of +8% holy resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Death Resilience", price = 500, itemtype = Concoction.Ids.DeathResilience, count = 1, description = "<i>Gives you one hour of +8% death resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Physical Resilience", price = 500, itemtype = Concoction.Ids.PhysicalResilience, count = 1, description = "<i>Gives you one hour of +8% physical resistance.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Fire Amplification", price = 500, itemtype = Concoction.Ids.FireAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on fire damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Ice Amplification", price = 500, itemtype = Concoction.Ids.IceAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on ice damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Earth Amplification", price = 500, itemtype = Concoction.Ids.EarthAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on earth damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Energy Amplification", price = 500, itemtype = Concoction.Ids.EnergyAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on energy damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Holy Amplification", price = 500, itemtype = Concoction.Ids.HolyAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on holy damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Death Amplification", price = 500, itemtype = Concoction.Ids.DeathAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on death damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
				{ name = "Physical Amplification", price = 500, itemtype = Concoction.Ids.PhysicalAmplification, count = 1, description = "<i>Gives you one hour of +8% amplification on physical damage you deal.</i>\n\nyou can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType= GameStore.CoinType.Online },
		}
	},
}

function generateExerciseOffers()
	local types = {
		Sword = {28552, 35279, 35285},
		Axe = {28553, 35280, 35286},
		Club = {28554, 35281, 35287},
		Bow = {28555, 35282, 35288},
		Rod = {28556, 35283, 35289},
	...
	for type, items in pairs(types) do
		...
		for i, tier in ipairs(tiers) do
			for _, offer in ipairs(tier.offers) do
				local item = ItemType(items[i])
				local name = tier.name .. " Exercise " .. type
				local charges = offer.charges
				local rate = 100 * (ExerciseSpeedMultipliers[tier.name] - 1)
				local description = "<i>Use this item to gain " .. charges .. " charges of " .. name .. " exercise weapon.</i>\n\n{info} shoots " .. rate .. "% faster than a regular training weapon\n{character}\n{storeinbox}\n{info} use it on exercise dummy to train your " .. type .. " skill\n{info} usable " .. charges .. " times a piece"
				local price = offer.price
				local coinType = offer.coinType or GameStore.CoinType.Transferable
				local newOffer = {
					icons = { "Exercise_" .. type ..".png" },
					name = name,
					price = price,
					itemtype = item:getId(),
					charges = charges,
					...
					coinType = coinType or Gamestore.CoinType.Transferable,
				}
				if newOffer.coinType == GameStore.CoinType.Transferable then
					table.insert(category.offers, newOffer)
				else
					table.insert(onlinePointsCategory.offers, newOffer)
				end
			end
		end
		table.insert(GameStore.Categories, category)
	end
	table.insert(GameStore.Categories, onlinePointsCategory)
end

generateExerciseOffers()
