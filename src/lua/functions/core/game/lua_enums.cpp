...
void LuaEnums::initConditionParamEnums(lua_State* L) {
	...
	registerEnum(L, CONDITION_PARAM_SKILL_LUCK);
	registerEnum(L, CONDITION_PARAM_SKILL_MELEE);
	registerEnum(L, CONDITION_PARAM_SKILL_DEXTERITY);
	registerEnum(L, CONDITION_PARAM_SKILL_RUNIC);
	registerEnum(L, CONDITION_PARAM_SKILL_DISTANCE);
	registerEnum(L, CONDITION_PARAM_SKILL_DEFENSE);
	registerEnum(L, CONDITION_PARAM_SKILL_TONICITY);
	...
	registerEnum(L, CONDITION_PARAM_SKILL_LUCKPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_MELEEPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_DEXTERITYPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_RUNICPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_DISTANCEPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_DEFENSEPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_TONICITYPERCENT);
...
void LuaEnums::initSkillEnums(lua_State* L) {
	...
	registerEnum(L, SKILL_LUCK);
	registerEnum(L, SKILL_MELEE);
	registerEnum(L, SKILL_DEXTERITY);
	registerEnum(L, SKILL_RUNIC);
	registerEnum(L, SKILL_DISTANCE);
	registerEnum(L, SKILL_DEFENSE);
	registerEnum(L, SKILL_TONICITY);
