...
bool IOLoginData::savePlayer(Player* player, bool async /* = false*/) {
	...
	query << "`skill_fist` = " << player->skills[SKILL_LUCK].level << ',';
	...
	query << "`skill_shielding` = " << player->skills[SKILL_DEFENSE].level << ',';
	query << "`skill_shielding_tries` = " << player->skills[SKILL_DEFENSE].tries << ',';
	query << "`skill_fishing` = " << player->skills[SKILL_TONICITY].level << ',';
	query << "`skill_fishing_tries` = " << player->skills[SKILL_TONICITY].tries << ',';
