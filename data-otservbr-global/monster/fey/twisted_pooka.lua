...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -causes [[drunkenness]] for 5 seconds, maxDamage = -causes [[drunkenness]] for 5 seconds, range = ?, effect = <>, target = ?}, --Star Wave
