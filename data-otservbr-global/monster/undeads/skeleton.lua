...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "In many dungeons around Tibia, like the Ancient Temple and Ghostlands. Also found in Rookgaard tombs and north east of Port Hope, in the jungle of Tiquanda, beneath Fenrock and in the desert Tombs, VengothVengoth Castle."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -7, maxDamage = -13, range = ?, effect = <>, target = ?}, --[[Life Drain]]
--}
monster.attacks = {
