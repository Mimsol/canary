...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -203, maxDamage = -203},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -77, maxDamage = -97, range = ?, effect = <>, target = ?}, --Dust Beam
