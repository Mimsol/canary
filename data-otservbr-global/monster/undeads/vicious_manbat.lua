...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --Bleeding Strike
...
--	{name ="healing", interval = 2000, chance = 20, minDamage = ?, maxDamage = ?},
--}
monster.attacks = {
