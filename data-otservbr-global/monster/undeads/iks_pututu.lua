...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -81, maxDamage = -88, range = ?, effect = <>, target = ?}, --Fire Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -50, maxDamage = -73, range = ?, effect = <>, target = ?}, --Fire Chain
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -79, maxDamage = -91, range = ?, effect = <>, target = ?}, --Earth Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -98, maxDamage = -114, range = ?, effect = <>, target = ?}, --Earth Strike
--	{name ="healing", interval = 2000, chance = 20, minDamage = 51, maxDamage = 71
  },
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -150},
