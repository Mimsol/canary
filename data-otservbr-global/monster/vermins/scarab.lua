...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Ankrahmun Tombs, the sand around Ankrahmun use a shovel, deep in Larva caves, the path leading to Chor, beneath Fenrock, Lions Rock."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -15, maxDamage = -25, range = ?, effect = <>, target = ?}, --Earth Strike
