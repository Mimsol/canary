...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --[[Poisoned|Poisons]] you up to 4 hp per turn
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -54, maxDamage = -79?, range = ?, effect = <>, target = ?}, --Poison Spit
--}
monster.attacks = {
