...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -1, maxDamage = -1, range = ?, effect = <>, target = ?}, --Drown damage [[Poisonball]]
--}
monster.attacks = {
...
monster.elements = {
	...
	{type = COMBAT_DROWNDAMAGE, percent = -400},
