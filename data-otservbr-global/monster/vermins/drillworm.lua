...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Drillworm Caves Mapper Coords127.142125.21152texthere, Lower Spike, Forsaken MineLost DwarvesLost Dwarf version of the Forsaken Mine, Oramond Factory Raids and Warzone 4."
}
