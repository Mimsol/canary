...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Zao Wailing Widow Cave, Muggy Plains during raid, Razachai, Northern Zao Plantations, Northern Brimstone Bug CavesBrimstone Bug Cave, Chyllfroest."
}
