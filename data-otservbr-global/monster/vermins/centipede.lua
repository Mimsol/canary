...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "All around Port Hope and Tiquanda, Dark Cathedral, Vandura, Meriana, Razachai, and Slime cave east of Venore, Arena and Zoo Quarter, Gnarlhound Caves."
}
