...
monster.Bestiary = {
	...
	Stars = 1,
	Occurrence = 0,
	Locations = "Zao Steppe, Yielothax DimensionRaging Mage tower, KhazeelAnkrahmun Desert, DevourerGeographyDarashia Desert, Drefia."
}
...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -3, maxDamage = -3},
--}
monster.attacks = {
