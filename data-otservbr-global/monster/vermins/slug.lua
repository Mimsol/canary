...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "South-east of Venore Mapper Coords128.204125.14472texthere, Swamp Troll Cave."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -0, maxDamage = -40, range = ?, effect = <>, target = ?}, --[[Earth Damage|Goo Spit]]
--}
monster.attacks = {
