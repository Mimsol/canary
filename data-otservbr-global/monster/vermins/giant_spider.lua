...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Plains of Havoc, Point of no Return in Outlaw Camp, Ghostlands, Hellgate, Mintwallin Secret Laboratory, Mad Mage Room deep below Ancient Temple, Mount Sternum Undead Cave, Green Claw Swamp, Maze of Lost Souls, Crusader Helmet Quest in the Dwarf Mines, Mushroom Gardens, west Drillworm Cavesdrillworm cave, Edron Hero Cave, Edron Orc Cave, on a hill near Drefia Mapper Coords129.7126.10473texthere, on a hill north-west of Ankrahmun inaccessible, Forbidden Lands, Deeper Banuta 2 small spawns, Mapper Coords128.113127.81112texthere and Mapper Coords128.21127.117122texthere, Malada, Ramoa, Arena and Zoo Quarter, second floor up of Cemetery Quarter, beneath Fenrock, VengothCastleVengoth Castle, Vandura Mountain, in a cave in Robson Isle, Chyllfroest, Spider Caves, Second floor of Krailos Spider Lair , Caverna Exanima."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -40, maxDamage = -70, range = ?, effect = <>, target = ?}, --Earth Strike
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --Poison Field on target
--}
monster.attacks = {
