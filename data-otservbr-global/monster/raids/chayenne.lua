local mType = Game.createMonsterType("Chayenne (Creature)")
local monster = {}

monster.description = "Chayenne"
monster.experience = 40,000
monster.outfit = {
	lookType = 155,
	lookHead = 78,
	lookBody = 0,
...
monster.health = 100,000+
monster.maxHealth = 100,000+
monster.race = "blood"
monster.corpse = 6081
monster.speed = 150
monster.manaCost = 0
...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -0, maxDamage = -2705?},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -0, maxDamage = -500?, range = ?, effect = <>, target = ?}, --Blue Musical Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -0, maxDamage = -640+, range = ?, effect = <>, target = ?}, --Life Drain
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -503+, range = ?, effect = <>, target = ?}, --Energy Missile
--	{name ="healing", interval = 2000, chance = 20, minDamage = 4000, maxDamage = 7000+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --[[Ultimate Explosion|Heart UE]]
