...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 150, maxDamage = 150},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -a purple field of music notes appears in front of Lethal Lissy, maxDamage = -a purple field of music notes appears in front of Lethal Lissy, range = ?, effect = <>, target = ?}, --[[Musical Notes]]
--}
monster.attacks = {
