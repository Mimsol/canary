...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -337, maxDamage = -574, range = ?, effect = <>, target = ?}, --Frequent [[Self Healing]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -309, maxDamage = -430, range = ?, effect = <>, target = ?}, --Ice Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -5secs~, maxDamage = -5secs~, range = ?, effect = <>, target = ?}, --Paralyze
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -182, maxDamage = -207, range = ?, effect = <>, target = ?}, --Ice Missile
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -389},
