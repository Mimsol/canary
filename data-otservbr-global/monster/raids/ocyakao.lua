...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0 60+, maxDamage = 0 60+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -Causes [[Bleeding]], maxDamage = -Causes [[Bleeding]], range = ?, effect = <>, target = ?}, --Blood Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -0, maxDamage = -20+, range = ?, effect = <>, target = ?}, --large [[Ice Wave]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -0, maxDamage = -100+, range = ?, effect = <>, target = ?}, --small [[Armageddon]]
--}
monster.attacks = {
