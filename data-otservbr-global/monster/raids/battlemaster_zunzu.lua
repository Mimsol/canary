...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -300, maxDamage = -350, range = ?, effect = <>, target = ?}, --[[Earth Damage|Poison]] attack
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -200, range = ?, effect = <>, target = ?}, --[[Whirlwind Throw]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -10, maxDamage = -20, range = ?, effect = <>, target = ?}, --[[Earth Damage|Poison]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 200, maxDamage = 350},
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -300},
