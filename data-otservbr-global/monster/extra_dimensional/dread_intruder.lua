...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -280, maxDamage = -350, range = ?, effect = <>, target = ?}, --Death Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -250, maxDamage = -400, range = ?, effect = <>, target = ?}, --Energy Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -it electrifies you, maxDamage = -it electrifies you, range = ?, effect = <>, target = ?}, --Electrified Ball
--}
monster.attacks = {
