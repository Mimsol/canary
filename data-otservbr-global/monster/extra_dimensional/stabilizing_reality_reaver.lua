...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -258+, range = ?, effect = <>, target = ?}, --[[Energy Wave]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --[[Invisibility]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 209+},
--}
monster.attacks = {
