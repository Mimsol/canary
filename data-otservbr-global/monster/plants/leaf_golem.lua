...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Leaf dungeon in Hellgate, Lair of the Treeling Witch, Forest Fury Camp and in the Forsaken MineForest FuriesForest Fury version of the Forsaken Mine."
}
