...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Meriana Gargoyle Cave, Ankrahmun Tombs, Malouquah, Goroma, Deeper Banuta, Formorgar Mines, Vengoth, Farmine Mines, Upper Spike and Medusa Tower."
}
...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 5, maxDamage = 15},
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -65}
}
