...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Cemetery Quarter, Alchemist Quarter and in the Arena and Zoo Quarter unreachable, VengothCastleVengoth Castle, Formorgar Mines, Lower Spike, Robson Isle single respawn, Krailos Ruins."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -115, maxDamage = -180, range = ?, effect = <>, target = ?}, --Earth Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -70, maxDamage = -130, range = ?, effect = <>, target = ?}, --Death Hit
--	{name ="healing", interval = 2000, chance = 20, minDamage = 60, maxDamage = 95
  },
