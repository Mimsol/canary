...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -? %, maxDamage = -? %, range = ?, effect = <>, target = ?}, --[[Damage Reflection]] of [[Physical Damage]]
--}
monster.attacks = {
