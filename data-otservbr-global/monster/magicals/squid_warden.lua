...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -600, maxDamage = -900, range = ?, effect = <>, target = ?}, --Ice Strike
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -600, maxDamage = -900, range = ?, effect = <>, target = ?}, --Icicle Berseker
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -700, range = ?, effect = <>, target = ?}, --Smoke Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -700, range = ?, effect = <>, target = ?}, --Music Beam
--}
monster.attacks = {
