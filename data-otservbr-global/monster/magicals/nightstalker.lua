...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Cemetery Quarter, VengothCastleVengoth Castle, Vandura Mountain, Robson Isle."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -60, maxDamage = -170, range = ?, effect = <>, target = ?}, --Holy Life Drain
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -, maxDamage = -, range = ?, effect = <>, target = ?}, --Invisible
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -sleep effect, maxDamage = -sleep effect, range = ?, effect = <>, target = ?}, --Paralyze
--	{name ="healing", interval = 2000, chance = 20, minDamage = 70, maxDamage = 130},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -[[Werewolf]], [[Vampire Lord]], [[Grim Reaper]] or [[Ferumbras]] [rare], maxDamage = -[[Werewolf]], [[Vampire Lord]], [[Grim Reaper]] or [[Ferumbras]] [rare], range = ?, effect = <>, target = ?}, --Creature Illusion
--}
monster.attacks = {
