...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Feyrist, in a cave located Mapper Coordstexthere131.10126.117210.50.5."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -150, range = ?, effect = <>, target = ?}, --[[Thunderstorm]] missile
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -0, maxDamage = -75, range = ?, effect = <>, target = ?}, --[[Mana Drain]]
