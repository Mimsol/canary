...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -210, maxDamage = -250, range = ?, effect = <>, target = ?}, --[[Fireball]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -100, maxDamage = -300, range = ?, effect = <>, target = ?}, --[[Heavy Magic Missile]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -25 [[hp]] for 3 turns, maxDamage = -25 [[hp]] for 3 turns, range = ?, effect = <>, target = ?}, --Electrifying Berserk
--	{name ="healing", interval = 2000, chance = 20, minDamage = 173?, maxDamage = ?},
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -130},
