...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Feyrist, in a cave located Mapper Coords131.10126.1172texthere."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -, maxDamage = -, range = ?, effect = <>, target = ?}, --Paralyze Red Shimmer Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -500, range = ?, effect = <>, target = ?}, --Explosion Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -300, range = ?, effect = <>, target = ?}, --Blood Berserk
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -unknown maybe buff, maxDamage = -unknown maybe buff, range = ?, effect = <>, target = ?}, --Frazzle Burp
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 50+},
--}
monster.attacks = {
