...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Forest Fury Camp, Dryad Gardens and in the Forsaken MineForest FuriesForest Fury version of the Forsaken Mine."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -100?, range = ?, effect = <>, target = ?}, --[[Distance Fighting|Spears]]
--}
monster.attacks = {
