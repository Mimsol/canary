...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Pirat Mine, The Wreckoning, Krailos Steppe."
}
...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -0, maxDamage = -400? at most 2 hits},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -100, maxDamage = -140?, range = ?, effect = <>, target = ?}, --Smoke wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -120, maxDamage = -160?, range = ?, effect = <>, target = ?}, --Blood Exori
--}
monster.attacks = {
