...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "OramondSouthern Plains, Minotaur Hills, Oramond Dungeon depending on Magistrate votes, Underground Glooth Factory, Oramond Fury Dungeon"
}
...
--monster.attacks = {
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -170+, range = ?, effect = <>, target = ?}, --[[Energy Damage|Energy Strike]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -0, maxDamage = -200+, range = ?, effect = <>, target = ?}, --[[Death Damage|Death Bomb]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -300+, range = ?, effect = <>, target = ?}, --[[Poison Damage|Poison Bomb]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -?, maxDamage = -?, range = ?, effect = <>, target = ?}, --Red sparkles on themselves
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -Causes heavy [[Paralysis]], maxDamage = -Causes heavy [[Paralysis]], range = ?, effect = <>, target = ?}, --Small Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -0, maxDamage = -110+, range = ?, effect = <>, target = ?}, --Small Stone [[Life Drain]]
--}
monster.attacks = {
