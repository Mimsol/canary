...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Cyclopolis, Mintwallin, Maze of Lost Souls, Dark Pyramid, Folda hidden cave, Kazordoon The Horned Foxs hideout, the Plains of Havoc, Bright Sword QuestPoint of No Return south of Outlaw Camp, Elvenbane, the depths of Fibula Dungeon level 50, cave east from Dwarf Bridge, Foreigner Quarter, Rookgaard Mino HellMinotaur Hell not reachable."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -35, maxDamage = -95, range = ?, effect = <>, target = ?}, --Fire Strike
