...
monster.Bestiary = {
	...
	Stars = 4,
	Occurrence = 0,
	Locations = "Warzone 2Warzones 2 and Warzone 33."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -0, maxDamage = -250+ on itself, range = ?, effect = <>, target = ?}, --[[Mana Drain]] ball
