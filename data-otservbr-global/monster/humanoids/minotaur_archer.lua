...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Ancient Temple, way to Mintwallin, FoldaFolda Underground Cave, Outlaw Camp, Plains of Havoc, KazordoonMinotaursKazordoon Minotaur Tower, DarkPyramidDaramian Minotaur Pyramid, Deeper Fibula Dungeon level 50 to open the door, Hero Cave, Foreigner Quarter and Elvenbane."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -80, range = ?, effect = <>, target = ?}, --Shoots [[bolt]]s
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -25},
