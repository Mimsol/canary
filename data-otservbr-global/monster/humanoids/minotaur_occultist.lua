...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -16?, maxDamage = -27?, range = ?, effect = <>, target = ?}, --[[Heavy Magic Missile]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -24?, maxDamage = -64?, range = ?, effect = <>, target = ?}, --[[Fireball]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --Energy Field
--}
monster.attacks = {
