...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Edron Troll-Goblin Peninsula, Abdendriel Shadow Caves, Thais South-East Troll Caves, Dusalks Troll Clan Cave, Island of Destiny in Paladins guild."
}
