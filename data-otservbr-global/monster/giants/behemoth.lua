...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Cyclopolis, deepest part of Tarpit Tomb after the flame, Forbidden Lands, Vandura Mountain, Deeper Banuta single spawn Mapper Coords127.220127.89142texthere, double spawn Mapper Coordstexthere127.234127.5914210.50.5, Serpentine Tower unreachable, deep into the Formorgar Mines, Arena and Zoo Quarter, Demon ForgeThe Dark Path, Lower Spike, Chyllfroest, Medusa Tower and Underground Glooth Factory west side."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -200, range = ?, effect = <>, target = ?}, --Boulder throw
--}
monster.attacks = {
