...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Plains of Havoc, Mount Sternum, Femor Hills, Cyclops Camp, Cyclopolis, Ancient Temple, Shadowthorn, Orc Fort, Mistrock, Foreigner Quarter, Outlaw Camp and in the Forsaken MineCyclopesCyclops version of the Forsaken Mine."
}
