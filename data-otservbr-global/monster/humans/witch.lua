...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Vandura, west of the Dwarf Mines in a small house Mapper Coords126.135125.173texthere, Amazon Tower north of Carlin, Triangle Tower, Temple of Xayepocax, Green Claw Swamp and Amazon Camp Venore, Dark Cathedral 2 levels underground, Goroma Volcano underground, west from Necromant House, Mammoth Shearing Factory, Trade Quarter in Yalahar, The Witches Cliff only accessible during a The Inquisition Questquest."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -25, maxDamage = -55, range = ?, effect = <>, target = ?}, --Fire Missile
