...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -34, range = ?, effect = <>, target = ?}, --Throws [[Snowball|Cold Snowball]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -Often; heals 30% of her entire [[health]], maxDamage = -Often; heals 30% of her entire [[health]], range = ?, effect = <>, target = ?}, --[[Self-Healing]]
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -20},
