...
--monster.attacks = {
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -500, range = ?, effect = <>, target = ?}, --Self destruct (explodes when reaches player)
--}
monster.attacks = {
