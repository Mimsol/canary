...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Throughout the Foreigner QuarterForeigner, Factory QuarterFactory, and Trade Quarters in Yalahar."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -25, range = ?, effect = <>, target = ?}, --Throws [[Throwing Knife|knives]]
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -70}
}
