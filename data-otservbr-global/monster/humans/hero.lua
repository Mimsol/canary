...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "In Hero Cave in Edron, it has many rooms with many kinds of monsters and different amounts of Heroes. Also in Magician Quarter, accompanied by other monsters. Old Fortress is now by far the largest respawn"
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -120, range = ?, effect = <>, target = ?}, --Shoots [[arrow]]s
