...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -0, maxDamage = -105?, range = ?, effect = <>, target = ?}, --Stalagmite
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 70?},
--}
monster.attacks = {
