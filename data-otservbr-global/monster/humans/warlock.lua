...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Demona, Ghostland Banshee Quest area, Temple of Xayepocax, Oasis Tomb, Kharos, Magician QuarterResidential AreaMagician Quarter, beneath Fenrock, The Arcanum, Old Masonry."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -180, range = ?, effect = <>, target = ?}, --[[Burst Arrow]]s
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -90, maxDamage = -180, range = ?, effect = <>, target = ?}, --Energy Missile
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -230, range = ?, effect = <>, target = ?}, --Great Cloud-Energy Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -120, range = ?, effect = <>, target = ?}, --Mana Drain
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -, maxDamage = -, range = ?, effect = <>, target = ?}, --Paralysis
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -20 seconds, often, maxDamage = -20 seconds, often, range = ?, effect = <>, target = ?}, --Invisible
--	{name ="healing", interval = 2000, chance = 20, minDamage = 100, maxDamage = 225},
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -130},
