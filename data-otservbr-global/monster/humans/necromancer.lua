...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "All the Tombs, Lich Hell, Drefia, Medusa Shield Quest room, Old Fortress, Old Masonry, beneath Fenrock, Cemetery Quarter, Magician Quarter, Mother of Scarabs Lair."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -10, maxDamage = -120, range = ?, effect = <>, target = ?}, --[[Death Hit]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -35, maxDamage = -95, range = ?, effect = <>, target = ?}, --Earth Missile
