...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Amazon Camp Venore, Amazon Camp Carlin, Amazonia, single respawn to the north west of Thais, Foreigner Quarter in Yalahar."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -50, range = ?, effect = <>, target = ?}, --Throws [[Spear]]s
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -70},
