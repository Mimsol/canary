...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Goroma, Formorgar Mines, Magician Quarter, Forbidden Temple. smallseealsoEnlightened of the CultSpawnssmall"
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -70, maxDamage = -185, range = ?, effect = <>, target = ?}, --Close range Divine Life Drain
