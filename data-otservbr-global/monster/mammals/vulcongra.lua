...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -on every turn, maxDamage = -on every turn, range = ?, effect = <>, target = ?}, --[[Soulfire]] exori
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -200, range = ?, effect = <>, target = ?}, --[[Fireball]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -196, maxDamage = -338+, range = ?, effect = <>, target = ?}, --Fire Beam
--}
monster.attacks = {
