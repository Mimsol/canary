...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -0, maxDamage = -115 + [[Poisoned|Poisons]] 1 [[hp]] for 5 turns},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -[[Poisoned|Poison]] starts at 3 hp/turn, maxDamage = -[[Poisoned|Poison]] starts at 3 hp/turn, range = ?, effect = <>, target = ?}, --Small Poisoning Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -lasts for 2 seconds, maxDamage = -lasts for 2 seconds, range = ?, effect = <>, target = ?}, --[[Charge]]
--}
monster.attacks = {
