...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 1,
	Locations = "Astral Shaper Ruins in two small rooms on the second floor, Mapper Coordstexthere128.131128.9115410.250.25 and to the east."
}
...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 195+},
--}
monster.attacks = {
