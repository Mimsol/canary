...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Alchemist Quarter, Arena and Zoo Quarter Inside the arena with other mutated creatures, Razachai, Vampire Castle on Vengoth, Robsons Isle, Mushroom Gardens, Souleater Mountains, Northern Zao Plantations, Middle Spike."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -45, maxDamage = -85, range = ?, effect = <>, target = ?}, --Envenom
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -5 hp/turn, maxDamage = -5 hp/turn, range = ?, effect = <>, target = ?}, --Poison Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -4 hp/turn, maxDamage = -4 hp/turn, range = ?, effect = <>, target = ?}, --Poison Berserk
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -70, range = ?, effect = <>, target = ?}, --Life Drain Berserk
