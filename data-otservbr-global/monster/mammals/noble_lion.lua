...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -star shaped; starts at 6? dmg, maxDamage = -star shaped; starts at 6? dmg, range = ?, effect = <>, target = ?}, --Bleeding explosion
--}
monster.attacks = {
