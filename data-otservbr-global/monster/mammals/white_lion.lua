...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -0, maxDamage = -350, range = ?, effect = <>, target = ?}, --Fire Cross on self
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -0, maxDamage = -380, range = ?, effect = <>, target = ?}, --Holy Cross on self
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -Starts at 15hp/turn, maxDamage = -Starts at 15hp/turn, range = ?, effect = <>, target = ?}, --Bleeding Cross on self
--}
monster.attacks = {
