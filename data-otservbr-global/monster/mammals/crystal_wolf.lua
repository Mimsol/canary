...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -?, range = ?, effect = <>, target = ?}, --T-Shaped Earth Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -40, maxDamage = -60, range = ?, effect = <>, target = ?}, --Ice area attack (X-Shaped)
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 65},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -60, range = ?, effect = <>, target = ?}, --Mana Drain
--}
monster.attacks = {
