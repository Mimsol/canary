...
monster.Bestiary = {
	...
	Stars = 1,
	Occurrence = 0,
	Locations = "Darama Devourer GeographyDevourer, Khalabal, in most grassy areas of Tibia, also found in Rookgaard and on Tutorial Island. There are also 2 unreachable Deer found near Fiehonjas protection zone."
}
