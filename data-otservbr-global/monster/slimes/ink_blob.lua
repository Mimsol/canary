...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -600, maxDamage = -900, range = ?, effect = <>, target = ?}, --Poison Burst Arrows
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -600, maxDamage = -850, range = ?, effect = <>, target = ?}, --Big Sparkles Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -700, maxDamage = -950, range = ?, effect = <>, target = ?}, --Small Sparkles Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -1200, maxDamage = -1650, range = ?, effect = <>, target = ?}, --Ripple Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -starts at 30, maxDamage = -45, range = ?, effect = <>, target = ?}, --[[Poison]]s you
--}
monster.attacks = {
