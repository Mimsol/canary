...
monster.Bestiary = {
	...
	Stars = 4,
	Occurrence = 0,
	Locations = "Pits of Inferno, The Inquisition QuestThe Vats - Edron and Grounds of Plague."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -160, maxDamage = -270, range = ?, effect = <>, target = ?}, --Poison Missiles
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -, maxDamage = -, range = ?, effect = <>, target = ?}, --Green Spark Ball
--	{name ="healing", interval = 2000, chance = 20, minDamage = 262, maxDamage = 350},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -, maxDamage = -, range = ?, effect = <>, target = ?}, --Curse Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -poisons you, maxDamage = -poisons you, range = ?, effect = <>, target = ?}, --Earth Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -120, maxDamage = -170, range = ?, effect = <>, target = ?}, --Poison Berserk
--}
monster.attacks = {
