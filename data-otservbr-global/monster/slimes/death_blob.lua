...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Alchemist Quarter, Drefia, Razachai, Souleater Mountains, Northern Zao Plantations and Yielothax DimensionRaging Mage tower."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -35, maxDamage = -60, range = ?, effect = <>, target = ?}, --Smoke Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -up to 52 hp/turn, maxDamage = -up to 52 hp/turn, range = ?, effect = <>, target = ?}, --[[Cursed|Curses]] you
