...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "In TiquandaReptile and Crustacean Cavesthe crocodile cave and the jungle east of Port Hope as well as the swamp to the north, Fenrock, Arena and Zoo Quarter, Trade Quarter, Talahu, also located on Meriana and Laguna Islands."
}
