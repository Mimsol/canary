...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -266, maxDamage = -328, range = ?, effect = <>, target = ?}, --Lightning Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -342, maxDamage = -364, range = ?, effect = <>, target = ?}, --Jaw Snap
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -231, maxDamage = -328, range = ?, effect = <>, target = ?}, --Explosion Strike
--}
monster.attacks = {
