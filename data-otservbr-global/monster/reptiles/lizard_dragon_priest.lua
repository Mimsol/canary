...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Zzaion, Zao Palace and its Zao Palace Antechambersantechambers, Muggy Plains, Corruption Hole, Razachai, Temple of Equilibrium, Northern Zao Plantations."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -125, maxDamage = -190, range = ?, effect = <>, target = ?}, --[[Fireball]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -poisons you, maxDamage = -poisons you, range = ?, effect = <>, target = ?}, --Stalagmite
--	{name ="healing", interval = 2000, chance = 20, minDamage = 200, maxDamage = 330},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --[[Invisibility]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --[[Summon]]s 2 [[Dragon Hatchling]]s at once
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -50},
