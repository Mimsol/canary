...
monster.Bestiary = {
	...
	Stars = 2,
	Occurrence = 0,
	Locations = "Chor, Forbidden Temple, Zzaion and Foreigner Quarter."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -70, range = ?, effect = <>, target = ?}, --Throws [[spear]]s
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -45},
