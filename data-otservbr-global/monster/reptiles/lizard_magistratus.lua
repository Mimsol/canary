...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -start from 2; up to 43, maxDamage = -start from 2; up to 43, range = ?, effect = <>, target = ?}, --[[Cursed]] 20 rounds
