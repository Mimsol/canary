...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Zzaion, Zao Palace, Muggy Plains, Zao Orc Land in fort, Razachai, Temple of Equilibrium."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -220, maxDamage = -371, range = ?, effect = <>, target = ?}, --[[Stalagmite]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 174, maxDamage = 275+},
--}
monster.attacks = {
