...
--monster.attacks = {
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -226, maxDamage = -250+, range = ?, effect = <>, target = ?}, --Blue Firework Explosion
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -182, maxDamage = -250+, range = ?, effect = <>, target = ?}, --Red Firework Bomb
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -unknown, maxDamage = -unknown, range = ?, effect = <>, target = ?}, --Teleport Bomb
--}
monster.attacks = {
