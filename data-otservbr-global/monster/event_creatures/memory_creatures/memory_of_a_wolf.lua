...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -186, maxDamage = -186},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -101, maxDamage = -250, range = ?, effect = <>, target = ?}, --Strike
