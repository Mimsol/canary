...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -236, maxDamage = -362, range = ?, effect = <>, target = ?}, --Ripple Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -349, maxDamage = -349, range = ?, effect = <>, target = ?}, --Ripple Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -297, maxDamage = -455, range = ?, effect = <>, target = ?}, --Ice Strike
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -250, maxDamage = -250, range = ?, effect = <>, target = ?}, --Icicle Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -174, maxDamage = -257, range = ?, effect = <>, target = ?}, --Mana drain
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -367; 3 rounds increasingly bigger ring up to 5sqm, maxDamage = -367; 3 rounds increasingly bigger ring up to 5sqm, range = ?, effect = <>, target = ?}, --Splash ring
--	{name ="healing", interval = 2000, chance = 20, minDamage = 80, maxDamage = 113},
--}
monster.attacks = {
