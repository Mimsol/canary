...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "TiquandaWater Elemental CaveWater Elemental Cave in Port Hope, Water Elemental Dungeon, Deeper Banuta, Malada, Ramoa, Talahu, Folda 7 spawn on the 3rd floor, Outlaw CampWater Elemental DungeonWater Elemental Cave in Outlaw Camp only during the Down the Drain Mini World Change, Krailos Steppe underwater cave."
}
