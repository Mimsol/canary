...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Edron Earth Elemental Cave 17 of them on the first floor, Vandura Mountain, Deeper Banuta 2 spawns, Mapper Coords127.231127.85122texthere and Mapper Coords127.219127.90142texthere, VengothVengoth Castle, Robson Isle, Drillworm Caves, Crystal Grounds, Middle Spike."
}
