...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -400+, range = ?, effect = <>, target = ?}, --[[Fire Bomb]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -300+, range = ?, effect = <>, target = ?}, --[[Fire Wave]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -400+, range = ?, effect = <>, target = ?}, --[[Fire Damage|Fire Beam]]
--}
monster.attacks = {
