...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --Fire Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --Fire Wave
--}
monster.attacks = {
