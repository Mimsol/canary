...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -153, maxDamage = -618, range = ?, effect = <>, target = ?}, --Blood Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -171, maxDamage = -313, range = ?, effect = <>, target = ?}, --Death Strike
