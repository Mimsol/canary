...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -?, maxDamage = -?, range = ?, effect = <>, target = ?}, --3sqm Green Sparkles Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -1100~, maxDamage = -1100~, range = ?, effect = <>, target = ?}, --Poison Exori
--}
monster.attacks = {
