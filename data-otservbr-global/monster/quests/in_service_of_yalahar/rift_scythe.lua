...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -, maxDamage = -, range = ?, effect = <>, target = ?}, --Sudden Death
--	{name ="healing", interval = 2000, chance = 20, minDamage = 120, maxDamage = 175
   },
--}
monster.attacks = {
