...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -0, maxDamage = -3800+, range = ?, effect = <>, target = ?}, --[[Mana Drain]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -, maxDamage = -, range = ?, effect = <>, target = ?}, --Death Berserk
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -524, range = ?, effect = <>, target = ?}, --Ranged Attack
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -0, maxDamage = -1050, range = ?, effect = <>, target = ?}, --Fire Beam
--	{name ="healing", interval = 2000, chance = 20, minDamage = 401, maxDamage = 499+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -1-8? [[Rift Worm]]s, 1-8? [[Rift Brood]]s, 1-8? [[Rift Scythe]], 1-5? [[War Golem]]s, maxDamage = -1-8? [[Rift Worm]]s, 1-8? [[Rift Brood]]s, 1-8? [[Rift Scythe]], 1-5? [[War Golem]]s, range = ?, effect = <>, target = ?}, --[[Summons]]
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -900},
