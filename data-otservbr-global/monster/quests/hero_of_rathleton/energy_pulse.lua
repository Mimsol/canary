...
--monster.attacks = {
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -5600+; vanishes after, maxDamage = -5600+; vanishes after, range = ?, effect = <>, target = ?}, --[[Energy Damage|Energy UE]]
--}
monster.attacks = {
