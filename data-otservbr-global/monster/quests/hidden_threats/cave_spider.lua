...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -0, maxDamage = -225+, range = ?, effect = <>, target = ?}, --Poison Spit
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -paralyzes you, maxDamage = -paralyzes you, range = ?, effect = <>, target = ?}, --poison spit
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -poisons for 18 hp/turn, maxDamage = -poisons for 18 hp/turn, range = ?, effect = <>, target = ?}, --Earth Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --[[Poison Bomb]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 150, maxDamage = 200},
--}
monster.attacks = {
