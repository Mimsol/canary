...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -0, maxDamage = -500?, range = ?, effect = <>, target = ?}, --[[Soulfire Beam]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -500?, range = ?, effect = <>, target = ?}, --[[Energy Wave]]
