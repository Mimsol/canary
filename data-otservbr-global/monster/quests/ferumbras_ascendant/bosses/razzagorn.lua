...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -500, maxDamage = -1000, range = ?, effect = <>, target = ?}, --[[Death Damage|Death Beam]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -700, range = ?, effect = <>, target = ?}, --[[Fire Damage|Fire Explosion]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -1000, range = ?, effect = <>, target = ?}, --[[Fire Wave]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -50, maxDamage = -800, range = ?, effect = <>, target = ?}, --[[Energy Wave]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = ?},
--}
monster.attacks = {
