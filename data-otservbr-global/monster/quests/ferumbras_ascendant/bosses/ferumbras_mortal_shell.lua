...
--monster.attacks = {
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -1700, maxDamage = -2000?, range = ?, effect = <>, target = ?}, --Great Death Beam
--	{name ="healing", interval = 2000, chance = 20, minDamage = 450, maxDamage = 5500?},
--}
monster.attacks = {
