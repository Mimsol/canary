...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -1500, maxDamage = -1500, range = ?, effect = <>, target = ?}, --Poison UE on target
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -450, maxDamage = -900, range = ?, effect = <>, target = ?}, --Poison Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -700, maxDamage = -800, range = ?, effect = <>, target = ?}, --Poison Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -150, maxDamage = -350, range = ?, effect = <>, target = ?}, --Poison Explosion
--	{name ="healing", interval = 2000, chance = 20, minDamage = 150, maxDamage = 600?},
--}
monster.attacks = {
