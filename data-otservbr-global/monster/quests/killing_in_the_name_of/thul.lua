...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -108, maxDamage = -137, range = ?, effect = <>, target = ?}, --Ice Ball on himself
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -170, range = ?, effect = <>, target = ?}, --[[Berserk]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -on himself, maxDamage = -on himself, range = ?, effect = <>, target = ?}, --[[Poison Bomb]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -, maxDamage = -, range = ?, effect = <>, target = ?}, --Paralyzing Snow Ball
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 293+},
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -285},
