...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -heavy, maxDamage = -heavy, range = ?, effect = <>, target = ?}, --[[Paralyze]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -60, maxDamage = -95, range = ?, effect = <>, target = ?}, --[[Stalagmite]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -40, maxDamage = -130, range = ?, effect = <>, target = ?}, --[[Berserk|Terra Berserk]]
--}
monster.attacks = {
