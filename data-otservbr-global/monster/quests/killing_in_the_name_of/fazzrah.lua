...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 168, maxDamage = 296+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -290+, range = ?, effect = <>, target = ?}, --Some Ranged Attack
--}
monster.attacks = {
