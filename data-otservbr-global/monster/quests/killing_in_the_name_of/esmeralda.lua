...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -0, maxDamage = -110, range = ?, effect = <>, target = ?}, --Poison Shot
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -poisons you starting at 5 [[hp]]/turn, maxDamage = -poisons you starting at 5 [[hp]]/turn, range = ?, effect = <>, target = ?}, --Poisoning Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -poisons you starting at 4 [[hp]]/turn, maxDamage = -poisons you starting at 4 [[hp]]/turn, range = ?, effect = <>, target = ?}, --Poisoning Berserk
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -0, maxDamage = -110, range = ?, effect = <>, target = ?}, --Life Drain Berserk
