...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -130, maxDamage = -170, range = ?, effect = <>, target = ?}, --Death Strike
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -250, maxDamage = -400, range = ?, effect = <>, target = ?}, --Poison Ball
