...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -0, maxDamage = -269, range = ?, effect = <>, target = ?}, --[[Death Damage|Death Beam]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -0, maxDamage = -337+, range = ?, effect = <>, target = ?}, --[[Death Damage|Death Strike]]
--}
monster.attacks = {
