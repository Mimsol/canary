...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -0, maxDamage = -1032+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -350–650, maxDamage = -350–650, range = ?, effect = <>, target = ?}, --Poison Missile
--}
monster.attacks = {
