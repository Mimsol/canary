...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -0, maxDamage = -268+, range = ?, effect = <>, target = ?}, --[[Ice Strike]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -0, maxDamage = -?, range = ?, effect = <>, target = ?}, --[[Holy Damage|Large Holy area attack]]
--}
monster.attacks = {
