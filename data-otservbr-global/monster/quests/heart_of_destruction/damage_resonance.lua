...
--monster.attacks = {
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -159+, range = ?, effect = <>, target = ?}, --Distance Attack
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 228+},
--}
monster.attacks = {
