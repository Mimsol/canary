...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -0, maxDamage = -939+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -3000+, range = ?, effect = <>, target = ?}, --Great Drain Explosion
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -312+, range = ?, effect = <>, target = ?}, --[[Energy Damage|Great Energy Beam]]
--}
monster.attacks = {
