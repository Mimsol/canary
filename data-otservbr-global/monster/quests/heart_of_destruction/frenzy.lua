...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 438+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -464+, range = ?, effect = <>, target = ?}, --[[Energy Effect|Energy Area attack on itself]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -730+, range = ?, effect = <>, target = ?}, --[[Energy Damage|Large Energy Wave]]
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1047},
