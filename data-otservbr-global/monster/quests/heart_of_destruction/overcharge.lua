...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -110, maxDamage = -350, range = ?, effect = <>, target = ?}, --[[Light Magic Missile]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -300, maxDamage = -670, range = ?, effect = <>, target = ?}, --[[Energy Beam]]
--}
monster.attacks = {
