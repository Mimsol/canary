...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -888+, range = ?, effect = <>, target = ?}, --Huge Area Attack
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -176+, range = ?, effect = <>, target = ?}, --Area attack
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -927+, range = ?, effect = <>, target = ?}, --[[Energy Damage|Great Energy Wave]]
--}
monster.attacks = {
