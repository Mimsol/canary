...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -619+, range = ?, effect = <>, target = ?}, --[[Ripple Effect|Great Drown Beam]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -?, range = ?, effect = <>, target = ?}, --[[Energy Damage|Great Energy Wave]]
--}
monster.attacks = {
