...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -0, maxDamage = -121+, range = ?, effect = <>, target = ?}, --[[Fire Damage|Large Fire Wave]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 546+},
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1393},
