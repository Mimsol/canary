...
monster.description = "a Drasilla"
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -80, maxDamage = -160, range = ?, effect = <>, target = ?}, --Fire Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -60, maxDamage = -130, range = ?, effect = <>, target = ?}, --Great Fireball
--	{name ="healing", interval = 2000, chance = 20, minDamage = 48, maxDamage = 65
   },
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -120},
