...
monster.description = "a The Masked Marauder"
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -197, maxDamage = -319, range = ?, effect = <>, target = ?}, --[[Distance Fighting|Throwing Knives]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -100+, range = ?, effect = <>, target = ?}, --Small Musical Wave
--	{name ="healing", interval = 2000, chance = 20, minDamage = 61, maxDamage = 88
  },
--}
monster.attacks = {
