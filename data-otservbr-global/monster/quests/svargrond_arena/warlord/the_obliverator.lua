...
monster.description = "a The Obliverator"
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -207, maxDamage = -273, range = ?, effect = <>, target = ?}, --Great Fireball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -148, maxDamage = -208+, range = ?, effect = <>, target = ?}, --Energy Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -50, maxDamage = -93, range = ?, effect = <>, target = ?}, --Mana Drain
...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 81, maxDamage = 104
  },
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -700},
