...
monster.description = "a The Pit Lord"
...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -0, maxDamage = -397},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -167, maxDamage = -200+, range = ?, effect = <>, target = ?}, --[[Boulders]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 52, maxDamage = 62+
  },
--}
monster.attacks = {
