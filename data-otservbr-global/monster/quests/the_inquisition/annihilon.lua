...
monster.description = "a Annihilon"
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -171, maxDamage = -300+, range = ?, effect = <>, target = ?}, --Groundshaker Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -?, maxDamage = -?, range = ?, effect = <>, target = ?}, --[[Groundshaker]] on itself
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -357, maxDamage = -500, range = ?, effect = <>, target = ?}, --Energy Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -poisons you 32 dmg/turn, maxDamage = -poisons you 32 dmg/turn, range = ?, effect = <>, target = ?}, --Poison Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -0, maxDamage = -200, range = ?, effect = <>, target = ?}, --Mana Drain Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -450, maxDamage = -800, range = ?, effect = <>, target = ?}, --Death Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -reduces speed by 785 points, maxDamage = -reduces speed by 785 points, range = ?, effect = <>, target = ?}, --Paralyze Ice Ball
...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 231, maxDamage = 368
  },
--}
monster.attacks = {
