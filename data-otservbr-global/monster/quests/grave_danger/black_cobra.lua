...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -[[Poisoned|Poisons]] you up to ? [[hp]]/turn, maxDamage = -[[Poisoned|Poisons]] you up to ? [[hp]]/turn, range = ?, effect = <>, target = ?}, --Poison Spit
--}
monster.attacks = {
