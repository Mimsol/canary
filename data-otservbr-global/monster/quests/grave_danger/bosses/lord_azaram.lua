...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -500, maxDamage = -1200?, range = ?, effect = <>, target = ?}, --[[Earth Damage|Rock Beam]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -300, maxDamage = -800?, range = ?, effect = <>, target = ?}, --[[Earth Damage|Small Poison Wave]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -300, maxDamage = -800?, range = ?, effect = <>, target = ?}, --[[Earth Damage|Large Poison Wave]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --applies [[Hexed|Lesser Hex]] on target
--}
monster.attacks = {
