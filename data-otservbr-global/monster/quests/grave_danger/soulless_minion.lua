...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 545+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -545+, range = ?, effect = <>, target = ?}, --Healing others
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -317+, range = ?, effect = <>, target = ?}, --[[Self-Healing|Life steal]]
--}
monster.attacks = {
