...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -180, maxDamage = -242+, range = ?, effect = <>, target = ?}, --Drown Explosion
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -78, maxDamage = -120, range = ?, effect = <>, target = ?}, --Ice Missile
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -up to 12[[hp]]/turn, maxDamage = -up to 12[[hp]]/turn, range = ?, effect = <>, target = ?}, --Poisoning Ball
--	{name ="healing", interval = 2000, chance = 20, minDamage = 31, maxDamage = 35
  },
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -175},
