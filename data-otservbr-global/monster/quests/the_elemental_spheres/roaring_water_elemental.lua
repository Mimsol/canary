...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -100, maxDamage = -300+, range = ?, effect = <>, target = ?}, --Drown Explosion
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -163, maxDamage = -253, range = ?, effect = <>, target = ?}, --Ice Missile
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -up to 23 [[hp]]/turn, maxDamage = -up to 23 [[hp]]/turn, range = ?, effect = <>, target = ?}, --Poisoning Ball
--	{name ="healing", interval = 2000, chance = 20, minDamage = 57, maxDamage = 78
  },
--}
monster.attacks = {
