...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -100, range = ?, effect = <>, target = ?}, --[[Throwing Knife]]s
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -summons 2 [[Pirate Marauder]]s, maxDamage = -summons 2 [[Pirate Marauder]]s, range = ?, effect = <>, target = ?}, --[[Summon|Musical Bomb]]
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -125},
