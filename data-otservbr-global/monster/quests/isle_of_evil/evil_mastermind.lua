...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -0, maxDamage = -77+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -66, maxDamage = -72+, range = ?, effect = <>, target = ?}, --[[Fireball]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -50, maxDamage = -78+, range = ?, effect = <>, target = ?}, --[[Sudden Death]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -36, maxDamage = -57+, range = ?, effect = <>, target = ?}, --[[Heavy Magic Missile]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -70, maxDamage = -73+, range = ?, effect = <>, target = ?}, --[[Life Drain|Distance Life Drain]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -59, maxDamage = -75+, range = ?, effect = <>, target = ?}, --[[Mana Drain]]
