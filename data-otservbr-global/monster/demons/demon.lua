...
monster.Bestiary = {
	...
	Stars = 4,
	Occurrence = 0,
	Locations = "Hero Cave, KharosFerumbras Citadel, Goroma, Ghostlands Warlock area unreachable, Liberty Bay hidden underground passage unreachable, Razachai, deep in Pits of Inferno found in every throneroom except Verminors, deep Formorgar Mines, Demon Forge, Alchemist Quarter, Magician Quarter, Chyllfroest, Oramond Dungeon, Abandoned Sewers, Hell Hub and Halls of Ascension."
}
