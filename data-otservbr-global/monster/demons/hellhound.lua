...
monster.Bestiary = {
	...
	Stars = 4,
	Occurrence = 0,
	Locations = "Pits of InfernoInfernatils Throneroom The Inquisition QuestThe Inquisition Quest Area, Hellgorge, Roshamuul Prison, Chyllfroest, Oramond Dungeon, The Extension Site and Asura Vaults."
}
