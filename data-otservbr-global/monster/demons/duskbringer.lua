...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 3,
	Locations = "Magician Quarter Yalahar one floor down around the httpstibia.fandom.comwikiMappercoords128.58-121.54-8-4-1-1 the lightbringers basin."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -200, maxDamage = -250?, range = ?, effect = <>, target = ?}, --Life Drain Sudden Death
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -200, maxDamage = -300?, range = ?, effect = <>, target = ?}, --Life Drain Hit
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -350},
