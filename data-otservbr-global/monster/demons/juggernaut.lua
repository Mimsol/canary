...
monster.Bestiary = {
	...
	Stars = 4,
	Occurrence = 0,
	Locations = "Deep in Pits of Inferno Apocalypses throne room, Demon ForgeTheDarkPathUshurielThe Dark Path, Demon ForgeTheBloodHallsMadarethThe Blood Halls, Demon ForgeTheVatsLatrivan.26GolgordanThe Vats, Demon ForgeTheHiveHellgorakThe Hive, Demon ForgeTheShadowNexusThe Shadow Nexus, a room deep in Formorgar Mines, Roshamuul Prison, Oramond Dungeon, Grounds of Destruction and Halls of Ascension."
}
