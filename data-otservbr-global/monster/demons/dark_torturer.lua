...
monster.Bestiary = {
	...
	Stars = 4,
	Occurrence = 0,
	Locations = "Pits of Inferno, Vengoth, The Inquisition QuestBlood Halls, Oramond Dungeon, Oramond Fury Dungeon, Roshamuul Prison, Grounds of Damnation and Halls of Ascension."
}
