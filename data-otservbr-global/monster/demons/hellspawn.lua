...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Magician Quarter, Vengoth, Deeper Banuta small spawn, Mapper Coords127.246127.116142texthere, Formorgar Mines 9x Mapper Coords125.182121.222114texthere, Chyllfroest, Oramond Dungeon, Asura Palace, Asura Vaults."
}
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -150, maxDamage = -175, range = ?, effect = <>, target = ?}, --Fire Missile
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -[[Burning|Burns]] you for 10 hp/26 turns, maxDamage = -[[Burning|Burns]] you for 10 hp/26 turns, range = ?, effect = <>, target = ?}, --Burning Strike
--}
monster.attacks = {
