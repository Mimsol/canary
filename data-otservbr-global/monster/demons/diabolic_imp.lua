...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -240, range = ?, effect = <>, target = ?}, --Plus Shaped Fireball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -430?, range = ?, effect = <>, target = ?}, --Great Fire Explosion
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -lasts in 1 second, maxDamage = -lasts in 1 second, range = ?, effect = <>, target = ?}, --[[Invisibility]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -lasts 2 seconds, maxDamage = -lasts 2 seconds, range = ?, effect = <>, target = ?}, --[[Strong Haste]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -650, maxDamage = -800, range = ?, effect = <>, target = ?}, --slow [[Self-Healing]]
--}
monster.attacks = {
