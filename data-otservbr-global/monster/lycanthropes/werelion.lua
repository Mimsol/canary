...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -0, maxDamage = -350, range = ?, effect = <>, target = ?}, --Fire Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -0, maxDamage = -425, range = ?, effect = <>, target = ?}, --Holy Strike
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -0, maxDamage = -250, range = ?, effect = <>, target = ?}, --Holy Wave
--}
monster.attacks = {
