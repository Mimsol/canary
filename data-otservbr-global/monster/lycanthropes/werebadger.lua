...
monster.Bestiary = {
	...
	Stars = 3,
	Occurrence = 0,
	Locations = "Grimvale -1 floor from ground level, also seen on surface during full moon 12th-14th of every month. Also in the Edron Lycanthropes Cave accessed Mapper Coords129.160124.17274texthere and in the Last Sanctum."
}
