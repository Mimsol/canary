...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -4, maxDamage = -12, range = ?, effect = <>, target = ?}, --Fire Explosion
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -22, maxDamage = -38, range = ?, effect = <>, target = ?}, --Fireball
--}
monster.attacks = {
