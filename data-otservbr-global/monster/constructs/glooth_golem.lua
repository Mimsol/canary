...
monster.attacks = {
	--{name ="melee", interval = 2000, chance = 100, skill = 60, attack = 50},  -- todoo Blood rage boost melee 375%
	--{name ="melee", interval = 2000, chance = 2, skill = 86, attack = 100}, -- todoo Blood rage boost melee 375%
